...
> |----------|----------|------------|------|
> | P1 | **Horizon** | fetch-immigration-data (THIS REPO) | Data collection — scans the horizon |
...
```bash
# P1 (Horizon — This Repo) — Data collection
...
2. **Verify downloads** → Check `downloads/` → Update `data-dictionary.md` → commit
